...
//	private ArrayList<String> assignees;
	...
	public IssueDetailsDialogController(IssueDetailsDialogView issueDetailsDialogView, int ID, String title,
			String author, String type, ArrayList<String> assignees)
	{
